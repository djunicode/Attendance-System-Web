...
urlpatterns = [
    ...
    path('download-sap-sheet/<str:subject>/<str:div>/<str:date_from>/<str:date_to>', views.DownloadSAPSheet.as_view(),
    ...
    path('get-previous-lecture-attendance/<str:div>/<str:date>/<str:startTime>',
