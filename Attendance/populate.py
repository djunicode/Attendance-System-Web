...
def fillSubject():
    Subject.objects.create(name="BEE", semester=1)
    Subject.objects.create(name="EM", semester=1)
    Subject.objects.create(name="SPA", semester=2)
    Subject.objects.create(name="ED", semester=2)
    Subject.objects.create(name="AP2", semester=2)
    Subject.objects.create(name="DS", semester=3)
    Subject.objects.create(name="OOPM", semester=3)
    Subject.objects.create(name="COA", semester=4)
    Subject.objects.create(name="OS", semester=4)
    Subject.objects.create(name="MP", semester=5)
    Subject.objects.create(name="BCE", semester=5)
    Subject.objects.create(name="DWH", semester=6)
    Subject.objects.create(name="SE", semester=6)
    Subject.objects.create(name="MCC", semester=7)
    Subject.objects.create(name="AISC", semester=7)
    Subject.objects.create(name="HMI", semester=8)
    Subject.objects.create(name="DC", semester=8)
